      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex flex-col items-start gap-4">
            <div className="flex items-center justify-center bg-white rounded-md px-3 py-2">
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-col gap-2 text-sm text-primary-foreground/70">
              <a href="https://forum-foceen.eventmaker.io/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                S'inscrire
              </a>
            </div>
          </div>
        </div>
        <div className="mt-8 pt-8 border-t border-white/10 text-center text-xs text-primary-foreground/50">
