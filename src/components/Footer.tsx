        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-col gap-2 text-sm text-primary/70">
              <a href="https://forum-foceen.eventmaker.io/" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                S'inscrire
              </a>
            </div>
          </div>
        </div>
        <div className="mt-8 pt-8 border-t border-primary/10 text-center text-xs text-primary/50">
